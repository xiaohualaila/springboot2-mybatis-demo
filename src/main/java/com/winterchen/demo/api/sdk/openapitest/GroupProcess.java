package com.winterchen.demo.api.sdk.openapitest;
...
import com.winterchen.demo.util.ServiceUtil;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;
import static com.winterchen.demo.api.sdk.openapi.DeviceManager.registerDevice;
import static com.winterchen.demo.api.sdk.openapi.GroupManager.*;
import static com.winterchen.demo.api.sdk.openapi.ProductManager.createProductTest;
    ...
    public void groupOne() {
     ...
     //   CreateDeviceGroupResponse.Data  groupObjectTemp =  createDeviceGroup(null , ServiceUtil.groupNameGenerator(),null);
      ...
      //  deleteDeviceGroup(groupObjectTemp.getGroupId());
        deleteDeviceGroup("08GJbZfiq9tVPHdAoOVc010200");
        //3 创建分组
